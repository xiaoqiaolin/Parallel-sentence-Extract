...
namespace TextProcess
{
    ...
    public struct result_t
    {
        ...
        public class NLPIR
        {
            ...
            const string path = @"F:\Project\Visual Studio 2012\Projects\TextProcess\TextProcess\DLL\NLPIR.dll";//设定dll的路径
            #endregion
            #region 对函数进行声明和包装
            #region 预判断
            ...
            private static extern bool NLPIR_Init(String sInitDirPath, String sLicenseCode ,int encoding=(int)NLPIR_CODE.GBK_CODE);
            /// <summary>
            /// 初始化，编码类型为GBK_CODE。
            /// </summary>
            /// <param name="sInitDirPath">Data所在目录。</param>
            ...
            {
                _Init = NLPIR_Init(sInitDirPath,"",0);
                return _Init;
            }
            /// <summary>
            /// 初始化。
            ...
            [DllImport(path, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, EntryPoint = "NLPIR_ParagraphProcessA")]
            ...
            {
                JudgeInit();
                result_t[] results = new result_t[nCount];//在客户端申请资源
            ...
            [DllImport(path, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, EntryPoint = "NLPIR_GetNewWords")]
            ...
            /// <param name="bWeightOut">是否输出权值。</param>
            /// <returns>新词列表。</returns>
            [DllImport(path, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, EntryPoint = "NLPIR_GetFileNewWords")]
            ...
            [DllImport(path, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, EntryPoint = "NLPIR_SetPOSmap")]
            ...
            [DllImport(path, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, EntryPoint = "NLPIR_FingerPrint")]
            ...
            //    #endregion
            //}
            public static int getcount(string sWord)
            {
                return NLPIR_GetParagraphProcessAWordCount(sWord);
            }
            public static result_t[] ProcessAW(string sWord, int count)
            {
